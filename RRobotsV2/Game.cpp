...
void Game::drawGame(SDL_Renderer* renderer)
{
          ...
          if (entBoard[y][x] >= 2 && entBoard[y][x] < 7)
            {
              if (characters.at(entBoard[y][x] - 2).getMarked())
                {
                  SDL_RenderCopy(renderer, marked.at(0).getTexture(),
                                 marked.at(0).getSpriteRect(WayType::NONE),
                                 characters.at(entBoard[y][x] - 2).getPositionRect());
                  
                  SDL_RenderCopyEx(renderer, characters.at(entBoard[y][x] - 2).getTexture(),
                                   characters.at(entBoard[y][x] - 2).getSpriteRect(way),
                                   characters.at(entBoard[y][x] - 2).getPositionRect(),
                ...
                {
                  SDL_RenderCopyEx(renderer, characters.at(entBoard[y][x] - 2).getTexture(),
                                   characters.at(entBoard[y][x] - 2).getSpriteRect(WayType::NONE),
                                   characters.at(entBoard[y][x] - 2).getPositionRect(),
                                   0, NULL, SDL_FLIP_NONE);
                }
            }
  ...
  SDL_RenderCopyEx(renderer, characters.at(markedCharacter).getTexture(),
                   characters.at(markedCharacter).getSpriteRect(way),
                   characters.at(markedCharacter).getPositionRect(),
                   0, NULL, SDL_FLIP_NONE);
}
